            ...
            <div className="display">
              ...
              >
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                  ...
                  <div>
                    <a href="https://x.com/gaurav44sharma1" target="_blank">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="35"
                        height="35"
                        fill="currentColor"
                        className="bi bi-twitter-x mt-2"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <div>
                    <a
                      href="https://www.instagram.com/6neerajsharma/"
                      target="_blank"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div>
                    <a href="mailto:neeraj716sharma@gmail.com" target="_blank">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        x="0px"
                        y="0px"
